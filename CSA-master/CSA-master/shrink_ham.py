...
import scipy as sp
n_elec = 6 # no. of ground state electrons of the respective molecule, modify accordingly
fn =sp.sparse.linalg.expm(-1e8*((n_op-n_elec*sp.sparse.identity(2**n_qubit))**2))
